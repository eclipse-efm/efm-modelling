...
import org.eclipse.efm.modeling.codegen.xlia.sdf.polygraph.ast.helper.MoccSystemHelper;
...
public class MoccSystem {
	...
	public MoccSystemHelper HELPER;
...
//	}
	...
	public MoccSystemFeature computeFeature() {
		FEATURE = new MoccSystemFeature(this);
...
//			int actorCount = 0;
//			for( int schedule = 0 ; (actorCount < getActor().size()) ; ++schedule) {
//				sout.append('\t').append("stage = [ " );
//				for( final MoccActor actor : getActor() ) {
//					if( actor.FEATURE.schedule == schedule ) {
//						sout.append(actor.getName()).append(' ');
//						++actorCount;
//					}
//				}
