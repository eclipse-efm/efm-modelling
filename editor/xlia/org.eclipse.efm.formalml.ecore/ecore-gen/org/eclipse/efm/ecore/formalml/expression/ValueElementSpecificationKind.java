...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Value Element Specification Kind</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.eclipse.efm.ecore.formalml.expression.ExpressionPackage#getValueElementSpecificationKind()
 * @model
 * @generated
 */
public enum ValueElementSpecificationKind implements Enumerator {
	...
	private static final ValueElementSpecificationKind[] VALUES_ARRAY =
		new ValueElementSpecificationKind[] {
			FIELD,
			INDEX,
			PARAMETER,
			FUNCTION,
	...
	/**
	 * A public read-only list of all the '<em><b>Value Element Specification Kind</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ValueElementSpecificationKind> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Value Element Specification Kind</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the '<em><b>Value Element Specification Kind</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	...
	/**
	 * Returns the '<em><b>Value Element Specification Kind</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
