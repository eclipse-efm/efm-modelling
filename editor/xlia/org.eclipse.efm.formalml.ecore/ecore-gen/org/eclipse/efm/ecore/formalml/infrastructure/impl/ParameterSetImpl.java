 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efm.ecore.formalml.infrastructure.impl.ParameterSetImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterSetImpl extends MinimalEObjectImpl.Container implements ParameterSet {
	...
	protected EClass eStaticClass() {
		return InfrastructurePackage.Literals.PARAMETER_SET;
	}
	...
	public EList<Parameter> getParameter() {
		if (parameter == null) {
			parameter = new EObjectContainmentEList<Parameter>(Parameter.class, this, InfrastructurePackage.PARAMETER_SET__PARAMETER);
		}
		return parameter;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case InfrastructurePackage.PARAMETER_SET__PARAMETER:
