 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efm.ecore.formalml.infrastructure.impl.ParameterImpl#getDirection <em>Direction</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterImpl extends PropertyDefinitionImpl implements Parameter {
	/**
	...
	protected EClass eStaticClass() {
		return InfrastructurePackage.Literals.PARAMETER;
	}
	...
	public void setDirection(ParameterDirectionKind newDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InfrastructurePackage.PARAMETER__DIRECTION, oldDirection, direction));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InfrastructurePackage.PARAMETER__DIRECTION:
				return getDirection();
		}
