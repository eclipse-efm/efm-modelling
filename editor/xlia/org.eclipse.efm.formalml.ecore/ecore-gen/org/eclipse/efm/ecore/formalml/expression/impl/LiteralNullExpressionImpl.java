...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Literal Null Expression</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efm.ecore.formalml.expression.impl.LiteralNullExpressionImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralNullExpressionImpl extends LiteralExpressionImpl implements LiteralNullExpression {
	/**
	 ...
	 * @generated
	 */
	protected LiteralNullExpressionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ExpressionPackage.Literals.LITERAL_NULL_EXPRESSION;
	}
	...
	public void setType(PrimitiveInstanceType newType) {
		if (newType != type) {
			...
			if (type != null)
				msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ExpressionPackage.LITERAL_NULL_EXPRESSION__TYPE, null, msgs);
			if (newType != null)
				msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ExpressionPackage.LITERAL_NULL_EXPRESSION__TYPE, null, msgs);
			msgs = basicSetType(newType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.LITERAL_NULL_EXPRESSION__TYPE, newType, newType));
	}
