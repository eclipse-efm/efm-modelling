 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efm.ecore.formalml.statement.impl.BlockStatementImpl#getOp <em>Op</em>}</li>
 *   <li>{@link org.eclipse.efm.ecore.formalml.statement.impl.BlockStatementImpl#getStatement <em>Statement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlockStatementImpl extends StatementImpl implements BlockStatement {
	...
	public void setOp(String newOp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatementPackage.BLOCK_STATEMENT__OP, oldOp, op));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StatementPackage.BLOCK_STATEMENT__OP:
				return getOp();
			case StatementPackage.BLOCK_STATEMENT__STATEMENT:
				return getStatement();
		}
