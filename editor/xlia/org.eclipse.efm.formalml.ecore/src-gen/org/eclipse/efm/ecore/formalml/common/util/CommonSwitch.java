...
public class CommonSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CommonPackage.ABSTRACT_ELEMENT: {
			...
			case CommonPackage.NAMED_ELEMENT: {
				...
				if (result == null) result = caseAbstractElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommonPackage.TYPE: {
			...
			case CommonPackage.TYPED_ELEMENT: {
				TypedElement typedElement = (TypedElement)theEObject;
				T result = caseTypedElement(typedElement);
				if (result == null) result = caseNamedElement(typedElement);
				if (result == null) result = caseAbstractElement(typedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommonPackage.CLASSIFIER_DEFINITION: {
				...
				if (result == null) result = caseType(classifierDefinition);
				if (result == null) result = caseNamedElement(classifierDefinition);
				if (result == null) result = caseAbstractElement(classifierDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
