 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efm.ecore.formalml.infrastructure.impl.RouteImpl#getSignals <em>Signals</em>}</li>
 *   <li>{@link org.eclipse.efm.ecore.formalml.infrastructure.impl.RouteImpl#getProtocol <em>Protocol</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RouteImpl extends NamedElementImpl implements Route {
	...
	protected EClass eStaticClass() {
		return InfrastructurePackage.Literals.ROUTE;
	}
	...
	public NotificationChain basicSetProtocol(ComProtocol newProtocol, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, InfrastructurePackage.ROUTE__PROTOCOL, oldProtocol, newProtocol);
	...
	public void setProtocol(ComProtocol newProtocol) {
		if (newProtocol != protocol) {
			...
			if (protocol != null)
				msgs = ((InternalEObject)protocol).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - InfrastructurePackage.ROUTE__PROTOCOL, null, msgs);
			if (newProtocol != null)
				msgs = ((InternalEObject)newProtocol).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - InfrastructurePackage.ROUTE__PROTOCOL, null, msgs);
			msgs = basicSetProtocol(newProtocol, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InfrastructurePackage.ROUTE__PROTOCOL, newProtocol, newProtocol));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case InfrastructurePackage.ROUTE__PROTOCOL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InfrastructurePackage.ROUTE__SIGNALS:
				return getSignals();
			case InfrastructurePackage.ROUTE__PROTOCOL:
				return getProtocol();
		}
