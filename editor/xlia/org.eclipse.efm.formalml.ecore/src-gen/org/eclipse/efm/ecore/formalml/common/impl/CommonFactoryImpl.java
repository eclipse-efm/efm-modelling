...
public class CommonFactoryImpl extends EFactoryImpl implements CommonFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case CommonPackage.QUALIFIED_NAME: return createQualifiedName();
			case CommonPackage.TYPE: return createType();
			case CommonPackage.TYPED_ELEMENT: return createTypedElement();
			case CommonPackage.CLASSIFIER_DEFINITION: return createClassifierDefinition();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case CommonPackage.VISIBILITY_KIND:
