 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efm.ecore.formalml.statement.impl.InterruptStatementImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.eclipse.efm.ecore.formalml.statement.impl.InterruptStatementImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterruptStatementImpl extends StatementImpl implements InterruptStatement {
	 ...
	 * @ordered
	 */
	protected static final InterruptStatementKind KIND_EDEFAULT = InterruptStatementKind.BREAK;
	 ...
	 * @ordered
	 */
	protected InterruptStatementKind kind = KIND_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return StatementPackage.Literals.INTERRUPT_STATEMENT;
	}
	...
	public void setKind(InterruptStatementKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatementPackage.INTERRUPT_STATEMENT__KIND, oldKind, kind));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StatementPackage.INTERRUPT_STATEMENT__EXPR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StatementPackage.INTERRUPT_STATEMENT__KIND:
				return getKind();
			case StatementPackage.INTERRUPT_STATEMENT__EXPR:
				return getExpr();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case StatementPackage.INTERRUPT_STATEMENT__KIND:
				setKind((InterruptStatementKind)newValue);
				return;
			case StatementPackage.INTERRUPT_STATEMENT__EXPR:
				getExpr().clear();
