...
/**
 * A sample validator interface for {@link org.eclipse.efm.ecore.formalml.statemachine.Transition}.
...
public interface TransitionValidator {
	...
	boolean validateMoe(TransitionMoe value);
	boolean validateTarget(NamedElement value);
	boolean validateBehavior(BlockStatement value);
	boolean validateTrigger(EList<InputComStatement> value);
	boolean validateGuard(AbstractGuardStatement value);
	boolean validateTguard(TimedGuardStatement value);
	boolean validateEffect(Statement value);
}
