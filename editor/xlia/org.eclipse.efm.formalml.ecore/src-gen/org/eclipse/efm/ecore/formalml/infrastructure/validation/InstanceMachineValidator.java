...
/**
 * A sample validator interface for {@link org.eclipse.efm.ecore.formalml.infrastructure.InstanceMachine}.
 * This doesn't really do anything, and it's not a real EMF artifact.
 * It was generated by the org.eclipse.emf.examples.generator.validator plug-in to illustrate how EMF's code generator can be extended.
 * This can be disabled with -vmargs -Dorg.eclipse.emf.examples.generator.validator=false.
 */
public interface InstanceMachineValidator {
	boolean validate();

	boolean validateModifier(Modifier value);
	boolean validateModel(Machine value);
	boolean validateArg(MixTupleExpression value);
	boolean validateSlot(EList<SlotProperty> value);
}
