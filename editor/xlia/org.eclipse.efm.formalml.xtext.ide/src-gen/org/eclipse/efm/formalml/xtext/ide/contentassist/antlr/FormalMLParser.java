...
public class FormalMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, FormalMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getMachineBlockAccess().getInput_enabledAssignment_0_2(), "rule__MachineBlock__Input_enabledAssignment_0_2");
			builder.put(grammarAccess.getMachineBlockAccess().getLifelineAssignment_0_3(), "rule__MachineBlock__LifelineAssignment_0_3");
			builder.put(grammarAccess.getMachineBlockAccess().getDesignAssignment_0_4(), "rule__MachineBlock__DesignAssignment_0_4");
			...
			builder.put(grammarAccess.getStatemachineAccess().getInput_enabledAssignment_1_2(), "rule__Statemachine__Input_enabledAssignment_1_2");
			builder.put(grammarAccess.getStatemachineAccess().getLifelineAssignment_1_3(), "rule__Statemachine__LifelineAssignment_1_3");
			builder.put(grammarAccess.getStatemachineAccess().getDesignAssignment_1_4(), "rule__Statemachine__DesignAssignment_1_4");
