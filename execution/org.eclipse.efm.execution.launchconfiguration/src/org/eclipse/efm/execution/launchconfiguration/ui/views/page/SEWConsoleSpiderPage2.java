...
public class SEWConsoleSpiderPage2 extends Page
...
//			BufferedReader bufferedReader2 = new BufferedReader(inputStreamReader2);
	        ...
	        if ( fSpider != null ) {
				SPIDER_GEOMETRY spiderGeometry =
						LaunchDelegate.isLaunchCoverageProfileFamily()
						? SPIDER_GEOMETRY.PENTAGON : SPIDER_GEOMETRY.TETRAGON;

				fSpider.resetSpider(spiderGeometry);
			}

			avmProcessBuilder = new ProcessBuilder(commandLine);
			avmProcessBuilder = avmProcessBuilder.redirectErrorStream(true);
			avmProcessBuilder.directory(workingDirectory);
