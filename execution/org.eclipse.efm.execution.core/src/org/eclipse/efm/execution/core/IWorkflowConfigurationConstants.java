...
public interface IWorkflowConfigurationConstants extends IWorkflowConfigurationSyntax {
	...
	String WORKSPACE_SELECTION_DIALOG =
	...
	String PLUGIN_LAUNCH_ID = Activator.PLUGIN_ID; //$NON-NLS-1$
...
////////////////////////////////////////////////////////////////////////////
	...
	String ATTR_SPECIFICATION_PROJECT_LOCATION =
			PLUGIN_LAUNCH_ID + ".ATTR_SPECIFICATION_PROJECT_LOCATION"; //$NON-NLS-1$

	String DEFAULT_SPECIFICATION_PROJECT_LOCATION =
			"<project-location>"; //$NON-NLS-1$


	String ATTR_SPECIFICATION_PROJECT_NAME =
			PLUGIN_LAUNCH_ID + ".ATTR_SPECIFICATION_PROJECT_NAME"; //$NON-NLS-1$

	String DEFAULT_SPECIFICATION_PROJECT_NAME =
			"<project-name>"; //$NON-NLS-1$


	String ATTR_SPECIFICATION_MODEL_FILE_LOCATION =
			PLUGIN_LAUNCH_ID + ".ATTR_SPECIFICATION_MODEL_FILE_LOCATION"; //$NON-NLS-1$

	String DEFAULT_SPECIFICATION_MODEL_FILE_LOCATION =
			"<spec-model-file-location.xlia>"; //$NON-NLS-1$

	String ATTR_SPECIFICATION_MODEL_ANALYSIS_PROFILE =
			PLUGIN_LAUNCH_ID + ".ATTR_SPECIFICATION_MODEL_ANALYSIS_PROFILE"; //$NON-NLS-1$

	String ATTR_BEHAVIOR_ANALYSIS_ELEMENT_NAME_LIST =
	...
	String ATTR_WORKSPACE_ROOT_LOCATION =
			PLUGIN_LAUNCH_ID + ".ATTR_WORKSPACE_ROOT_LOCATION"; //$NON-NLS-1$

	String DEFAULT_WORKSPACE_ROOT_LOCATION =
			"<workspace-root-folder-location>"; //$NON-NLS-1$

	String ATTR_WORKSPACE_OUTPUT_FOLDER_NAME =
			PLUGIN_LAUNCH_ID + ".ATTR_WORKSPACE_OUTPUT_FOLDER_NAME"; //$NON-NLS-1$

	String DEFAULT_WORKSPACE_OUTPUT_FOLDER_NAME =
			"output"; //$NON-NLS-1$


	String ATTR_WORKSPACE_LOG_FOLDER_NAME =
			PLUGIN_LAUNCH_ID + ".ATTR_WORKSPACE_LOG_FOLDER_NAME"; //$NON-NLS-1$

	String DEFAULT_WORKSPACE_LOG_FOLDER_NAME =
			"log"; //$NON-NLS-1$


	String ATTR_WORKSPACE_DEBUG_FOLDER_NAME =
			PLUGIN_LAUNCH_ID + ".ATTR_WORKSPACE_DEBUG_FOLDER_NAME"; //$NON-NLS-1$

	String DEFAULT_WORKSPACE_DEBUG_FOLDER_NAME =
			"debug"; //$NON-NLS-1$
	...
	String ATTR_SPECIFICATION_STOP_CRITERIA_TIMEOUT =
	...
	String ATTR_SPECIFICATION_ANALYZE_STRATEGY =
	...
	String ATTR_TRANSITION_COVERAGE_SCOPE =
			PLUGIN_LAUNCH_ID + ".ATTR_TRANSITION_COVERAGE_SCOPE"; //$NON-NLS-1$

	String ATTR_TRANSITION_COVERAGE_SELECTION =
	...
	String ATTR_BEHAVIOR_SELECTION_HOJ_JUMP_HEIGHT =
			PLUGIN_LAUNCH_ID + ".ATTR_BEHAVIOR_SELECTION_HOJ_JUMP_HEIGHT"; //$NON-NLS-1$

	int DEFAULT_BEHAVIOR_SELECTION_HOJ_JUMP_HEIGHT = 6;

	String ATTR_BEHAVIOR_SELECTION_HOJ_JUMP_TRIALS_LIMIT =
			PLUGIN_LAUNCH_ID + ".ATTR_BEHAVIOR_SELECTION_HOJ_JUMP_TRIALS_LIMIT"; //$NON-NLS-1$

	String ATTR_BEHAVIOR_SELECTION_HOJ_HIT_COUNT =
			PLUGIN_LAUNCH_ID + ".ATTR_BEHAVIOR_SELECTION_HOJ_HIT_COUNT"; //$NON-NLS-1$

	String ATTR_BEHAVIOR_SELECTION_HOJ_JUMP_COUNT =
	...
	String ATTR_TEST_OFFLINE_TRACE_FILE_LOCATION =
			PLUGIN_LAUNCH_ID + ".ATTR_TRACE_FILE_LOCATION"; //$NON-NLS-1$

	String DEFAULT_TEST_OFFLINE_TRACE_FILE_LOCATION =
			"<merge-trace-file-path>"; //$NON-NLS-1$

	String ATTR_TEST_OFFLINE_PURPOSE_FILE_LOCATION =
			PLUGIN_LAUNCH_ID + ".ATTR_TEST_PURPOSE_FILE_LOCATION"; //$NON-NLS-1$

	String DEFAULT_TEST_OFFLINE_PURPOSE_FILE_LOCATION =
			"<test-purpose-file-path>"; //$NON-NLS-1$

	String ATTR_TEST_OFFLINE_ENABLED_TRACE_CONFIGURATION =
			PLUGIN_LAUNCH_ID + ".ATTR_TEST_OFFLINE_ENABLED_TRACE_CONFIGURATION"; //$NON-NLS-1$



	String ATTR_TEST_OFFLINE_OBSERVABLE_SPECIFICATION =
			PLUGIN_LAUNCH_ID + ".ATTR_TEST_OFFLINE_OBSERVABLE_TRACE"; //$NON-NLS-1$

	List<String> DEFAULT_TEST_OFFLINE_OBSERVABLE_SPECIFICATION
			= Arrays.asList(
	...
	String ATTR_TEST_OFFLINE_CONTROLLABLE_SPECIFICATION =
			PLUGIN_LAUNCH_ID + ".ATTR_TEST_OFFLINE_CONTROLLABLE_TRACE"; //$NON-NLS-1$

	List<String> DEFAULT_TEST_OFFLINE_CONTROLLABLE_SPECIFICATION
			= Arrays.asList(
					"input#env = [*]"
			);
	...
	String ATTR_OPAQUE_MODULE_TEXTUAL_CONFIGURATION =
			PLUGIN_LAUNCH_ID + ".ATTR_OPAQUE_MODULE_TEXTUAL_CONFIGURATION"; //$NON-NLS-1$

	String DEFAULT_OPAQUE_MODULE_TEXTUAL_CONFIGURATION
	...
	String ATTR_OPAQUE_MODULE_ENABLED_AS_ADDITIONAL_WORKER =
			PLUGIN_LAUNCH_ID + ".ATTR_OPAQUE_MODULE_ENABLED_AS_ADDITIONAL_WORKER"; //$NON-NLS-1$

	boolean DEFAULT_OPAQUE_MODULE_ENABLED_AS_ADDITIONAL_WORKER = false;
	...
	String ATTR_BASIC_TRACE_ENABLED_GENERATION =
...
//					"input      = \\t%2%->%3% ? %4%\\n",
	...
	String ATTR_SEQUENCE_DIAGRAM_TRACE_FORMAT_ELEMENT_LIST =
			PLUGIN_LAUNCH_ID + ".ATTR_SEQUENCE_DIAGRAM_TRACE_FORMAT_ELEMENT_LIST"; //$NON-NLS-1$

	List<String> DEFAULT_SEQUENCE_DIAGRAM_TRACE_FORMAT_ELEMENT_LIST
	= Arrays.asList(
			"line#wrap#width = 80",
			"line#wrap#separator = \"\\n\"",
//			%1% --> execution context ID
...
//			%1% --> condition,
	...
	String ATTR_TTCN_ENABLED_GENERATION =
			PLUGIN_LAUNCH_ID + ".ATTR_TTCN_ENABLED_GENERATION"; //$NON-NLS-1$

	String ATTR_TTCN_ENABLED_CUSTOMIZATION =
			PLUGIN_LAUNCH_ID + ".ATTR_TTCN_ENABLED_CUSTOMIZATION"; //$NON-NLS-1$

	boolean DEFAULT_TTCN_ENABLED_CUSTOMIZATION = false;


	String ATTR_TTCN_FOLDER_NAME =
			PLUGIN_LAUNCH_ID + ".ATTR_TTCN_FOLDER_NAME"; //$NON-NLS-1$

	String DEFAULT_TTCN_FOLDER_NAME =
			"TTCN"; //$NON-NLS-1$


	List<String> DEFAULT_TTCN_TRACE_SPECIFICATION
			= Arrays.asList(
					SYNTAX_TRACE_SPECIFICATION_LINK,
					"input#env  = [*]\n",
					"output#env = [*]\n"
	...
	String ATTR_TTCN_CONTROL_MODULE_NAME =
			PLUGIN_LAUNCH_ID + ".ATTR_TTCN_CONTROL_MODULE_NAME"; //$NON-NLS-1$

	String DEFAULT_TTCN_CONTROL_MODULE_NAME =
			"TTCN_ControlPart"; //$NON-NLS-1$


	String ATTR_TTCN_DECLARATIONS_MODULE_NAME =
			PLUGIN_LAUNCH_ID + ".ATTR_TTCN_DECLARATIONS_MODULE_NAME"; //$NON-NLS-1$

	String DEFAULT_TTCN_DECLARATIONS_MODULE_NAME =
			"TTCN_Declarations"; //$NON-NLS-1$


	String ATTR_TTCN_TEMPLATES_MODULE_NAME =
			PLUGIN_LAUNCH_ID + ".ATTR_TTCN_TEMPLATES_MODULE_NAME"; //$NON-NLS-1$

	String DEFAULT_TTCN_TEMPLATE_MODULE_NAME =
			"TTCN_Templates"; //$NON-NLS-1$


	String ATTR_TTCN_TESTCASES_MODULE_NAME =
			PLUGIN_LAUNCH_ID + ".ATTR_TTCN_TESTCASES_MODULE_NAME"; //$NON-NLS-1$

	String DEFAULT_TTCN_TESTCASES_MODULE_NAME =
			"TTCN_TestsAndControl"; //$NON-NLS-1$


	String ATTR_TTCN_TESTCASES_STARTING_WRAPPER =
			PLUGIN_LAUNCH_ID + ".ATTR_TTCN_TESTCASES_STARTING_WRAPPER"; //$NON-NLS-1$

	String DEFAULT_TTCN_TESTCASES_STARTING_WRAPPER =
//			%1% --> <system identifier>
			"\t\tf_start();"; //$NON-NLS-1$


	String ATTR_TTCN_TESTCASES_ENDING_WRAPPER =
			PLUGIN_LAUNCH_ID + ".ATTR_TTCN_TESTCASES_ENDING_WRAPPER"; //$NON-NLS-1$

	String DEFAULT_TTCN_TESTCASES_ENDING_WRAPPER =
//			%1% --> <system identifier>
			"\t\tf_end();"; //$NON-NLS-1$


	String ATTR_TTCN_TESTCASES_SENDING_WRAPPER =
			PLUGIN_LAUNCH_ID + ".ATTR_TTCN_TESTCASES_SENDING_WRAPPER"; //$NON-NLS-1$

	String DEFAULT_TTCN_TESTCASES_SENDING_WRAPPER =
			"\t\t%7%_send( %8% );";
...
//	%8% --> <port parameters template message>
	...
	String ATTR_TTCN_TESTCASES_RECEIVING_WRAPPER =
			PLUGIN_LAUNCH_ID + ".ATTR_TTCN_TESTCASES_RECEIVING_WRAPPER"; //$NON-NLS-1$

	String DEFAULT_TTCN_TESTCASES_RECEIVING_WRAPPER =
			"\t\t%7%_receive( %8% );";


	String ATTR_TTCN_ADAPTATION_MODULE_NAME =
			PLUGIN_LAUNCH_ID + ".ATTR_TTCN_ADAPTATION_MODULE_NAME"; //$NON-NLS-1$

	String DEFAULT_TTCN_ADAPTATION_MODULE_NAME =
			"TTCN_Adaptation"; //$NON-NLS-1$


	String ATTR_TTCN_ADAPTATION_UTILS_IMPL =
			PLUGIN_LAUNCH_ID + ".ATTR_TTCN_ADAPTATION_UTILS_IMPL"; //$NON-NLS-1$

	String DEFAULT_TTCN_ADAPTATION_UTILS_IMPL
...
//	%8% --> <port parameters template message>
	...
	String ATTR_TTCN_TESTCASES_RECEIVING_IMPL =
			PLUGIN_LAUNCH_ID + ".ATTR_TTCN_TESTCASES_RECEIVING_IMPL"; //$NON-NLS-1$

	String DEFAULT_TTCN_TESTCASES_RECEIVING_IMPL
	...
	String ATTR_FIRST_SYMBEX_OUTPUT_GRAPHVIZ_FORMAT_SPEC =
			PLUGIN_LAUNCH_ID + ".ATTR_FIRST_SYMBEX_OUTPUT_GRAPHVIZ_FORMAT_SPEC"; //$NON-NLS-1$

	List<String> DEFAULT_SYMBEX_OUTPUT_GRAPHVIZ_FORMAT_SPEC
			= Arrays.asList(
					// %1% --> node#id
					// %2% --> node#label
					// %3% --> node#css
...
//					"output     = %1%->%3% ? %4%",
	...
	String ATTR_FIRST_SYMBEX_OUTPUT_GRAPHVIZ_CSS_SPEC =
			PLUGIN_LAUNCH_ID + ".ATTR_FIRST_SYMBEX_OUTPUT_GRAPHVIZ_CSS_SPEC"; //$NON-NLS-1$

	List<String> DEFAULT_SYMBEX_OUTPUT_GRAPHVIZ_CSS_SPEC
			// Node color / shape
			= Arrays.asList(
	...
	String ATTR_SECOND_SYMBEX_OUTPUT_GRAPHVIZ_FORMAT_SPEC =
			PLUGIN_LAUNCH_ID + ".ATTR_ENABLED_SECOND_SYMBEX_OUTPUT_GRAPHVIZ_FORMAT_SPEC"; //$NON-NLS-1$


	////////////////////////////////////////////////////////////////////////////
	// SYMBEX:  a.k.a. SYMBEX TUNING OPTION
	////////////////////////////////////////////////////////////////////////////

	String ATTR_SYMBEX_OPTION_CONSTRAINT_SOLVER =
			PLUGIN_LAUNCH_ID + ".ATTR_SYMBEX_OPTION_CONSTRAINT_SOLVER"; //$NON-NLS-1$

	String ATTR_SYMBEX_OPTION_TEXTUAL_CONFIGURATION =
