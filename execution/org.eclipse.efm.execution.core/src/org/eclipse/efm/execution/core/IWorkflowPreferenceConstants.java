...
public interface IWorkflowPreferenceConstants {
	 ...
	 */
	public static final String PLUGIN_ID = "org.eclipse.efm.execution"; //$NON-NLS-1$;

	public static final String UI_PLUGIN_ID = "org.eclipse.efm.execution.ui"; //$NON-NLS-1$;
