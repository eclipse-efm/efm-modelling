...
public class TestAdapterFactory extends AdapterFactoryImpl {
	...
	protected TestSwitch<Adapter> modelSwitch =
		new TestSwitch<Adapter>() {
			@Override
			public Adapter caseOfflineTestWorker(OfflineTestWorker object) {
				return createOfflineTestWorkerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.efm.execution.core.workflow.test.OfflineTestWorker <em>Offline Test Worker</em>}'.
	 * <!-- begin-user-doc -->
