...
public abstract class AbstractSymbexWorkflowView extends ViewPart implements ILaunchConfigurationGUIelement {
	...
	public void setWarningMessage(String warningmessage){
		...
		message_image_display.setImage(ImageResources.getImageDescriptor(ImageResources.IMAGE__WARNING_ICON).createImage());
		message_display_parentcomposite.layout();
	}
	...
	public void setErrorMessage(String errormessage){
		...
		message_image_display.setImage(ImageResources.getImageDescriptor(ImageResources.IMAGE__ERROR_ICON).createImage());
		message_display_parentcomposite.layout();
	}
